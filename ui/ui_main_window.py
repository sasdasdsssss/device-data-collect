...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graph9 = QVBoxLayout(self.verticalLayoutWidget_8)
        self.graph9.setObjectName(u"graph9")
        self.graph9.setSizeConstraint(QLayout.SetMaximumSize)
        self.graph9.setContentsMargins(0, 0, 0, 0)
